	...
	<section class="content-header">
        <div class="col-xs-12">
          <div class="box">
			...
			<form method="post" action="<?=base_url()?>index.php/jurnal/proses_payment" autocomplete="off">
			  ...
			  ?>
				<tr>
					...
					<td width="25%">
						<input type="text" class="form-control" size='1' name="prjct" value="<?=$row->id_penawaran?>" readonly>
