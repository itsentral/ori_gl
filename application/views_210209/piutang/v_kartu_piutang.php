      ...
      <div class="box">
        <div class="box-header">
           ...
           <!-- <div class="box-body table-responsive no-padding"> -->
						<form method="post" action="<?=base_url()?>index.php/kartu_piutang/tampilkan_kartu_piutang" autocomplete="off">
							...
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									<tr>
										...
										$supp  = $this->db->query("SELECT * FROM ori_dev.customer WHERE id_customer='$klien'")->row();
										...
										echo "<tr><th colspan='8' style='text-align:center;font-size:15px;'><center>NAMA KLIEN : ". $supp->nm_customer . "</center></th></tr>";
