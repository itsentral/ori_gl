...
<table width='50%' border="1" cellpadding="5" cellspacing="0">
	...
	<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>NAMA KLIEN : " . $supp->nama_klien . "</center></th></tr>";
									...
									<!-- DATA DARI JURNAL -->
											...
											$detail_jurnal	= $this->Kartupiutang_model->get_detail_kartu_piutang($awal,$akhir,$klien);
											if ($detail_jurnal > 0) {
												$count2 = 0;
												$count3 = 0;
