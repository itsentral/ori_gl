...
header("Content-Disposition: attachment; filename=Rekap_kartu_piutang_$datawal-$datakhir.xls"); //ganti nama sesuai keperluan
...
<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>REKAP KARTU PIUTANG<br>Periode :  " . date_format(new DateTime($awal), "d-m-Y") . " S/D ". date_format(new DateTime($akhir), "d-m-Y") ."</center></th></tr>";
									...
									<?php
										...
										foreach ($vendor as $vend) {
											...
											$detail_jurnal	= $this->Kartupiutang_model->get_rekap_kartu_piutang($awal,$akhir,$id_supplier);
