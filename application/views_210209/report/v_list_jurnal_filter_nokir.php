				...
				<div class="box-header">
					<div class="box-body" style="background-color:lightblue">
						<form action="<?= base_url() ?>index.php/report/filter_tgl_jurnal" method="post">
							...
							<br><br>
							<div class="col-xs-2">
								Dari Tanggal :<input type="text" class="form-control" size='1' id="datepicker" format="dd-mm-yyyy" data-date-format="dd-mm-yyyy" name="tanggal" value="<?= date("d-m-Y") ?>" readonly><br><br>
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									if ($filter_nok > 0) {
										$arr_nokir	= array();
										foreach ($filter_nok as $row_temp) {
											$num_temp++;
											if (!empty($row_temp->no_perkiraan)) {
												$arr_nokir[]	= $row_temp->no_perkiraan;
												...
												echo "<td style='text-align:center'>" . $row_temp->nama . "</td>";
