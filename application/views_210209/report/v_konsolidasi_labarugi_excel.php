...
header("Content-Disposition: attachment; filename=Laporan_Konsolidasi_Laba_Rugi_Lv3_$data_bulan_post-$data_tahun_post.xls");//ganti nama sesuai keperluan
...
<tr>
						...
						<?php			
								if($nokir_6811a_konsolidasi > 0){
									foreach($nokir_6811a_konsolidasi as $row6811){
										$nokir_biaya11 			= $row6811->no_perkiraan;
										$nm_perkiraan_biaya11		= $row6811->nama;
										$pYTD_biaya11				= $row6811->sum6811;
										$cmonth_biaya11				= $row6811->sumtrans6811;
										$YTD_biaya11					= $pYTD_biaya11 + $cmonth_biaya11;														
						?>
						<tr>
							<td><?=$nokir_biaya11?></td>
							<td><?=$nm_perkiraan_biaya11?></td>
							<td align="right">
								<?=$rp_pYTD_biaya11			= "Rp. " . number_format($pYTD_biaya11,0,',','.');?>
							</td>
							<td align="right">
								<?=
									$rp_cmonth_biaya11		= "Rp. " . number_format($cmonth_biaya11,0,',','.');
								?>
							</td>
							<td align="right">
								<?=
									$rp_YTD_biaya11			= "Rp. " . number_format($YTD_biaya11,0,',','.');
								?>
							</td>		
						</tr>
						<?php
						...
						?>
						<?php			
								if($nokir_6821a_konsolidasi > 0){
									foreach($nokir_6821a_konsolidasi as $row6821){
										$nokir_biaya21 			= $row6821->no_perkiraan;
										$nm_perkiraan_biaya21		= $row6821->nama;
										$pYTD_biaya21				= $row6821->sum6821;
										$cmonth_biaya21				= $row6821->sumtrans6821;
						...
						<?php			
								if($nokir_6831a_konsolidasi > 0){
									...
									foreach($nokir_6831a_konsolidasi as $row6831){
										$nokir_biaya31 			= $row6831->no_perkiraan;
										$nm_perkiraan_biaya31		= $row6831->nama;
										$pYTD_biaya31				= $row6831->sum6831;
										$cmonth_biaya31				= $row6831->sumtrans6831;
										$YTD_biaya31					= $pYTD_biaya31 + $cmonth_biaya31;
										
										$SubTotalBiaya2_pYTD		=  $pYTD_biaya11 + $pYTD_biaya21 + $pYTD_biaya31;
										$SubTotalBiaya2_cmonth		=  $cmonth_biaya11 + $cmonth_biaya21 + $cmonth_biaya31;
										$SubTotalBiaya2_YTD 		=  $YTD_biaya11 + $YTD_biaya21 + $YTD_biaya31;
