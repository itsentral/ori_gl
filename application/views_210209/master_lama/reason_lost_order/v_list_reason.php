    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
			...
			<div class="box-body">
			  <button class="btn btn-warning btn-sm" onclick="return add_data()">Tambah Alasan <i class="fa fa-plus"></i>
			  </button>
            </div>
            <!-- /.box-header -->
...
<script>
  ...
  function edit_data(id){
	$.get( "<?= base_url(); ?>index.php/master/edit_reason_lost_order" , { id :id } , function ( data ) {
  ...
  function add_data(){
	$.get( "<?= base_url(); ?>index.php/master/add_reason_lost_order" , { option :"" } , function ( data ) {
		$( '#show_modal' ) . html ( data ) ;
		$('#myModal').modal('show');
	} ) ;
  }
