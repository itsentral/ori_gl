    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
			...
			<form method="post" action="<?=base_url()?>index.php/order/save_tambah_new">
			<table class="table table-bordered table-striped">
				...
				<tr>
					...
					<td>
						...
						$id_aju		= $ret[0]->id+1;
						?>
						<input type="text" name="id" id="id" readonly value="<?=$id_aju?>" class="form-control">
					</td>
					<td><b>Supplier</b></td>
				...
				<thead>
					...
					<td colspan="6">
						...
						<div class="form-group has-success col-lg-1">
							<input type="text" class="form-control" id="area" value =""  onkeypress="return isNumber(event)" name="qty[]" placeholder="Qty">
						</div>
