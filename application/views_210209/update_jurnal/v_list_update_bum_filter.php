			...
			<div class="box">
				<div class="box-header">
					<div class="box-body" style="background-color:lightblue">
						<form action="<?= base_url() ?>index.php/update_jurnal/filter_update_jurnal_bum" method="post">
							<table>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<a href="<?= base_url() ?>index.php/update_jurnal/update_bum" title='Refresh' class='btn btn-primary btn-sm'><i class='fa fa-refresh'></i> Refresh</a>
									</td>
								</tr>
							</table>
						</form>
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									?>
											<tr bgcolor='#DCDCDC'>
												<td align="center"><a href="<?= base_url() ?>index.php/update_jurnal/edit_jurnal_bum/<?= $row->nomor ?>" data-toggle="tooltip" title="Click for detail"><?= $row->nomor ?></a></td>
												...
												<td style="text-align:center"><a href="<?= base_url() ?>index.php/update_jurnal/edit_jurnal_bum/<?= $row->nomor ?> " title='Edit' class='btn btn-primary btn-sm'><i class='fa fa-pencil-square-o'></i> Edit</a></td>
											</tr>
									<?php
										}
									}
