	  	...
	  	<div class="modal-dialog" style="display:show;">
			<div class="modal-content">
				...
				<div class="box-body table-responsive no-padding">
					<form method='post' action="<?=base_url().'index.php/master/proses_edit_event';?>" enctype="multipart/form-data">
						...
						<div class="form-group has-success col-lg-4">
						  ...
						  <input type="text" class="form-control" id="nm_event" name='nm_event' placeholder="Masukan Nama Event" value="<?= $nm_event; ?>">
						</div>

						<div class="form-group has-success col-lg-4">
						  <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i> Lokasi</label>
						  <input type="text" class="form-control" id="lokasi" name='lokasi' placeholder="Masukan Lokasi" value="<?=$lokasi?>">
						</div>

						<div class="form-group has-success col-lg-4">
						  <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i> Tanggal</label>
						  <input type="text" class="form-control" id="date_event" name='date_event' format="dd-mm-yyyy" data-date-format="yyyy-mm-dd" placeholder="Masukan Tanggal Event" value="<?=$date_event?>">
						</div>
