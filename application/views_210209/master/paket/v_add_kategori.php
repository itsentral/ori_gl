			...
			<div class="modal-header">
				...
				<form method='post' action="<?=base_url().'index.php/master/proses_add_kategori_paket';?>" enctype="multipart/form-data">
					<div class="form-group has-success col-lg-6"  id="c_user_id">
					  ...
					  <input type="text" class="form-control" id="nm_kategori" name='nm_kategori' placeholder="Masukan Nama Kategori Paket" value="">
					</div>
					<div class="form-group has-success col-lg-6"  id="c_name">
					  ...
					  <input type="text" class="form-control" onkeypress="return isNumber(event)" id="harga" name='harga' placeholder="Masukan Harga" value="">
					</div>
