        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
				<form method="post" action="<?=base_url()?>index.php/order/proses_reques_vendor">
					<table width="100%" class="table table-bordered">
						...
						<tr>
							...
							<td id="jenis">
							<input type="text" name="jenis_vendora" class="form-control" placeholder="jenis vendor" id="jenis_vendora" readonly value="" >
							</td>
						</tr>
						<tr>
							...
							<td><input type="text" onkeypress="return isNumber(event)" class="form-control" name="jumlah" placeholder="Masukan jumlah request" id="jumlah" value="" ></td>
						</tr>
						<tr>
