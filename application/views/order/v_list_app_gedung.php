              ...
              <table class="table table-bordered table-hover dataTable example1">
				...
				<tbody>
					...
					<tr>
					  ...
					  if($row->sts == '2'){
					  ?>
						<a href="<?=base_url()?>index.php/order/app_gedung2/<?=$idx?>" title="Approve Request" class="btn btn-danger" width="20%" onclick="return confirm_app()"><i class="fa fa-close"></i></a>
					  <?php
					  }else if($row->sts == '1'){
					  ?>
						<a href="<?=base_url()?>index.php/order/rjk_gedung/<?=$idx?>" title="Reject Request" class="btn btn-warning" width="20%" onclick="return confirm_rjk()"><i class="fa fa-edit"></i></a>
					  <?php
					  }else{
					  ?>
						<a href="<?=base_url()?>index.php/order/app_gedung2/<?=$idx?>" title="Approve Request" class="btn btn-info" width="20%" onclick="return confirm_app()"><i class="fa fa-check"></i></a>
						<a href="<?=base_url()?>index.php/order/rjk_gedung/<?=$idx?>" title="Reject Request" class="btn btn-warning" width="20%" onclick="return confirm_rjk()"><i class="fa fa-close"></i></a>
					  <?php
					  }
					  ?>
					  </td>
