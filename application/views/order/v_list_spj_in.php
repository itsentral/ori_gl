              ...
              <table class="table table-bordered table-hover dataTable example1">
				...
				<tbody>
					...
					<tr>
					  ...
					  <td><?=$row->out_by?></td>
					  <td width="15%">
						<a href='<?=base_url()?>index.php/order/print_in/<?=$row->no_spj;?>/<?=str_replace("|","_",$row->id_penawaran)?>' title='Print Semua Item' target='blank' class='btn btn-info' width='20%' ><i class='fa fa-print'></i></a>
					  </td>
					</tr>
					<?php
							}
