...
header("Content-Disposition: attachment; filename=Umur_kartu_hutang.xls"); //ganti nama sesuai keperluan
...
<table width='50%' border="1" cellpadding="5" cellspacing="0">
							...
							<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='9' style='text-align:center;font-size:15px;'><center>UMUR KARTU HUTANG<br>Periode :  " .$akhir2. " </center></th></tr>";
										echo "<tr><th colspan='9' style='text-align:center;font-size:15px;'><center>NAMA SUPPLIER : " . $supp->nama . "</center></th></tr>";
