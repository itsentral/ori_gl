      ...
      <div class="box">
        <div class="box-header">
           ...
           <!-- <div class="box-body table-responsive no-padding"> -->
						<form method="post" action="<?=base_url()?>index.php/kartu_hutang/tampilkan_kartu_hutang" autocomplete="off">
              <table class="table">			 
								<tr>
							...
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='8' style='text-align:center;font-size:15px;'><center>KARTU HUTANG<br>Periode :  " . date_format(new DateTime($awal), "d-m-Y") . " S/D ". date_format(new DateTime($akhir), "d-m-Y") ."</center></th></tr>";
