      ...
      <div class="box">
        <div class="box-header">
           ...
           <!-- <div class="box-body table-responsive no-padding"> -->
						<form method="post" target="_blank" action="<?=base_url()?>index.php/report/tampilkan_ap" autocomplete="off">
				...
				<div class="row">
					...
					<div class="box-header">
						...
						<div class="box-body">
							...
							<tr>
								...
								//
												if($data_bulan_post > 0){
														...
														if($nm_bln == 1){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br>Periode : Januari ".$data_tahun_post."</center></th></tr>";															
														}elseif($nm_bln == 2){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Februari ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 3){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Maret ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 4){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : April ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 5){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Mei ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 6){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Juni ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 7){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Juli ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 8){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Agustus ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 9){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : September ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 10){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Oktober ".$data_tahun_post."</center></th></tr>";
														}elseif($nm_bln == 11){
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : November ".$data_tahun_post."</center></th></tr>";
														}else{
															echo "<tr><th colspan='5' style='text-align:center;font-size:15px;'><center>LAPORAN HUTANG<br><br>Periode : Desember ".$data_tahun_post."</center></th></tr>";
														}														
												}
											?>
							</tr>
							...
							<tr>
								<td><center><b>Tgl Invoice</b></center></td>
								<td><center><b>No. Invoice</b></center></td>
								<td><center><b>Nama Vendor</b></center></td>
							...
							<?php
								...
								if($data_ar > 0){
									...
									foreach($data_ar as $row){
										...
										$tglinv =$row->tgl_invoice;
										$tgl_invoice				= date('d-m-Y', strtotime($tglinv));
