      ...
      <div class="box">
        <div class="box-header">
           ...
           <!-- <div class="box-body table-responsive no-padding"> -->
						<form method="post" action="<?=base_url()?>index.php/Dp_hutang/rekap_dp_hutang" autocomplete="off">
							...
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='8' style='text-align:center;font-size:15px;'><center>REKAP UANG MUKA SUPPLIER<br>Periode :  " . date_format(new DateTime($awal), "d-m-Y") . " S/D ". date_format(new DateTime($akhir), "d-m-Y") ."</center></th></tr>";
									...
									<?php
										...
										foreach ($vendor as $vend) {
											...
											$detail_jurnal	= $this->Dphutang_model->get_rekap_kartu_um($awal,$akhir,$id_supplier,$tipe);
