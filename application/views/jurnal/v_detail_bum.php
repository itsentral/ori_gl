			...
			<div class="box">
				<div class="box-header">
					<div class="box-body" style="background-color:lightblue">
						<?php
						$data_header = $this->db->query("SELECT * FROM jarh WHERE nomor='$nomor_jurnal'")->row();
						?>
						<form action="<?= base_url() ?>index.php/report/filter_query_jurnal" method="post">
							<table width="100%">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control input-sm" size='1' id="filter_text" name="filter_text" value="<?= $data_header->note ?>" readonly>
									</td>
									<td></td>
									<td>
										<b>Tanggal</b>
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr bgcolor='#9acfea'>
										...
										<th>
											<center>Debit USD </center>
										</th>
										<th>
											<center>Kredit USD</center>
										</th>
									</tr>
								</thead>
								<tbody>
									...
									if ($list_data > 0) {
										...
										foreach ($list_data as $row) {
											...
											$sum_debet_usd	+= $row->nilai_valas_debet;
											$sum_kredit_usd	+= $row->nilai_valas_kredit;
									...
									?>
											<tr bgcolor='#DCDCDC'>
												...
												<td align="right"><?= $format_debet_usd ?></td>
												<td align="right"><?= $format_kredit_usd ?></td>
											</tr>
									<?php
										}
									}
									...
									<tr bgcolor='#DCDCDC'>
										...
										<td align="right"><b><?= $format_sumdebet_usd ?></b></td>
										<td align="right"><b><?= $format_sumkredit_usd ?></b></td>
									</tr>
									<tr bgcolor='#DCDCDC'>
										<td colspan="8" align="left">
											<a href="<?= base_url() ?>index.php/Multi_bum" class="btn btn-success">Kembali</a>&nbsp;
