									...
									if ($filter_tgl > 0) {
										...
										foreach ($filter_tgl as $row_temp) {
											...
											if (!empty($row_temp->tgl)) {
												...
												$data_uang_keluar_dari = $this->db->query("SELECT a.*,b.nama FROM jurnal a left join coa_master b on a.no_perkiraan=b.no_perkiraan WHERE a.nomor='$id_buk' and a.no_perkiraan like '11%' limit 1")->result();
