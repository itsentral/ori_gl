...
<section class="content">
	<div class="row">
		<div class="col-lg-12 col-xs-12">
			<form method="post" action="<?= base_url() ?>index.php/jurnal/proses_input_dana_keluar" id="form-proses-bro">
					...
					<div class="box-body">
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<!-- TGL INPUT -->
								<input type="text" class="form-control" size='1' id="datepicker" name="tanggal" value="<?= date('d-m-Y') ?>" data-date-format="dd-mm-yyyy">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control input-sm" name="kepada" id="kepada" autocomplete="off" value="">
							</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#add_field_button').click(function() {
			...
			if (total_row < max_fields) {
				...
				Template += '</td>';
				Template += '<td>';
				Template += '<input type="text" class="form-control input-sm harga" name="detail[' + awal + '][jumlah]" id="jumlah' + awal + '" onblur="stopCalculation(' + awal + ');" onfocus="startCalculation(' + awal + ');" data-decimal="." data-thousand="" data-prefix="" data-precision="0">';
				Template += '</td>';
				Template += '<td>';
	...
	function Calculation2() {
		...
		$('#totalusd').val(grand_tot2.format(0, 3, ','));
	}
