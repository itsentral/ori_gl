...
<section class="content-header">
	<div class="row">	<?php // div 1 ?>
	<div class="col-xs-12">	<?php // div 2 ?>
      	<div class="box">	<?php // div 3 ?>
        	<div class="box-header">	<?php // div 4 ?>
				<div class="box-body">	<?php // div 5 ?>
		...
		<!-- <div class="col-xs-12"> 			<?php // div 1a ?>
			<div class="box">				<?php // div 2a ?> -->
				<div class="box-header">	<?php // div 3a ?>					
					<div>
						<h3>
							<b>TABEL LABA RUGI KOTOR</b>
						</h3>
					</div>
					<div class="box-body table-responsive no-padding">	<?php // div 4a ?>
		...
		<div class="col-xs-12"> 			<?php // div 1b ?>
			<div class="box">				<?php // div 2b ?>
				<div class="box-header">	<?php // div 3b ?>
					<div>
						<h3>
	...
	<!-- <div class="col-xs-12">		<?php // div 1c ?> -->
			<!-- <div class="box">	<?php // div 2c ?> -->
				<div class="box-header">		<?php // div 3c ?>					
					<div>
						<h3>
		...
		<!-- /.box-header -->
					<div class="box-body table-responsive no-padding">		<?php // div 4c ?>	
						<table class="table table-bordered">
            <!-- <table class="table table-bordered table-hover dataTable example1"> -->
							<thead>
								<tr class="bg-primary">																
		...
		<div class="col-xs-12"> 			<?php // div 1d ?>
			<div class="box">				<?php // div 2d ?>
				<div class="box-header">	<?php // div 3d ?>
					<div>
						<h3>
				...
				<div class="box-header">		<?php // div 1e ?>					
					<div>
						<h3>
					...
					<div class="box-body table-responsive no-padding">		<?php // div 2e ?>	
						<table class="table table-bordered">
							<thead>
								<tr class="bg-primary">																
                					<th><center>ACCOUNT</center></th>
		...
		<div class="col-xs-12"> 			<?php // div 1f ?>
			<div class="box">				<?php // div 2f ?>
				<div class="box-header">	<?php // div 3f ?>
					<div>
						<h3>
							<right><b>GRAFIK BIAYA</b></right>
						</h3>								
					</div>
					<div id="container8" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
				</div>		<?php // div 3f ?>
			
				<div class="box-header">		<?php // div 1g ?>					
					<div>
						<h3>
							<b>TABEL BIAYA</b>
						</h3>
					...
					<div class="box-body table-responsive no-padding">		<?php // div 2g ?>	
						<table class="table table-bordered">
							<thead>
								<tr class="bg-primary">																
                					<th><center>ACCOUNT</center></th>
							...
							<tbody>
								...
								<tr class="bg-info">
									...
									<td align="right" width="12%"><?=number_format($sept_by,0,',','.');?>
									<td align="right" width="12%"><?=number_format($okt_by,0,',','.');?>
									<td align="right" width="12%"><?=number_format($nov_by,0,',','.');?>
									<td align="right" width="12%"><?=number_format($des_by,0,',','.');?>
								</tr>
							</tbody>
						</table>
							<div id="show_stock"></div>
