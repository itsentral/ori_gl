...
<table width='50%' border="1" cellpadding="5" cellspacing="0">
	...
	<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>KARTU PIUTANG<br>Periode :  " . date_format(new DateTime($awal), "d-m-Y") . " S/D ". date_format(new DateTime($akhir), "d-m-Y") ."</center></th></tr>";
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>NAMA KLIEN : " . $supp->nm_customer . "</center></th></tr>";
