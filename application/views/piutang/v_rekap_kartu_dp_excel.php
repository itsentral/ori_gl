...
header("Content-Disposition: attachment; filename=Rekap_kartu_dp_$datawal-$datakhir.xls"); //ganti nama sesuai keperluan
...
<tbody>
									...
									<tr>
										...
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>REKAP KARTU DP<br>Periode :  " . date_format(new DateTime($awal), "d-m-Y") . " S/D ". date_format(new DateTime($akhir), "d-m-Y") ."</center></th></tr>";
