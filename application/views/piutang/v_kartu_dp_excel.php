...
header("Content-Disposition: attachment; filename=Kartu_dp_$datawal-$datakhir.xls"); //ganti nama sesuai keperluan
...
<table width='50%' border="1" cellpadding="5" cellspacing="0">
	...
	<tbody>
									...
									<tr>
										...
										$supp  = $this->db->query("SELECT * FROM sentralsistem.customer WHERE id_customer='$klien'")->row();
											
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>KARTU DP<br>Periode :  " . date_format(new DateTime($awal), "d-m-Y") . " S/D ". date_format(new DateTime($akhir), "d-m-Y") ."</center></th></tr>";
										echo "<tr><th colspan='6' style='text-align:center;font-size:15px;'><center>NAMA CUSTOMER : " . $supp->nm_customer . "</center></th></tr>";
