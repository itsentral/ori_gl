                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-body table-responsive no-padding">
                                        <form action="<?=base_url()?>index.php/Latihan/setup_bum" method="post">		
                                         ...
                                         ?>
                                          <tr>
					                        <td width="10%">Nomor BUM</td>
                                      
					                            <td>
					                                <input type="text" class="form-control" size='15%' name="bum" id="bum" value="<?=$nobum?>">
					                            </td>
				                        </tr>
                                        <tr>
