	...
	<div class="modal" id='myModal' style="display:show;">
	  <div class="modal-dialog" style="display:show;">
		<div class="modal-content">
			...
			<form method='post' action="<?=base_url().'index.php/Latihan/proses_edit_master_coa';?>" enctype="multipart/form-data">
			...
			<div class="form-group has-success col-lg-6"  id="c_jabatan">
					...
					<div class="form-group has-success col-lg-6"  id="c_new_password">
					  ...
					  <input type="text" class="form-control" id="bln" name="bln" placeholder="Masukkan kode" value="<?=$bln?>">
					</div>
					<div class="form-group has-success col-lg-6"  id="c_new_password">
					  <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i> Tahun</label>
					  <input type="text" class="form-control" id="thn" name="thn" placeholder="Masukkan kode" value="<?=$thn?>">
					</div>
