			...
			<div class="box">
				<div class="box-header">
					...
					<div class="box-body">
						...
						<a href="<?= base_url() ?>index.php/Latihan/excel_ledger_control/<?=$levels?>" title="Print Semua Item" target="blank" class="btn btn-info" width="">EXPORT TO EXCEL<i class=""></i></a>
