      ...
      <div class="box">
        <div class="box-header">
           ...
           <!-- <div class="box-body table-responsive no-padding"> -->
						<form method="post" action="<?=base_url()?>index.php/laporan/tampilkan_labarugi_event" autocomplete="off">
...
<script>
	...
	function changeValue(id){
		$.get( "<?= base_url(); ?>index.php/laporan/change_lr_event" , { option : id } , function ( data ) {
