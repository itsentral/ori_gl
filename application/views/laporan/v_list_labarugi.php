						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="teksBiru" align="right" style="border-right:none; border-bottom-style:none; border-left-style:none;"><b><?= $rp_SubTotalHpp_pYTD		= "Rp. " . number_format($SubTotalHpp_pYTD2+$total_pYTD_hpp5104+$total_pYTD_hpp5105+$total_pYTD_hpp5103+$total_pYTD_hpp, 0, ',', '.'); ?></b></td>
