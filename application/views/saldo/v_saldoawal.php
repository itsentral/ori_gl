			...
			<div class="box">
				<div class="box-header">
					<div class="box-body">
						...
						<div class="col-xs-4"><input type="text" value="2023" name="thn" class="form-control" readonly tabindex="-1"></div>
						<div class="col-xs-2"><input type="text" value="4" name="bln" class="form-control" readonly tabindex="-1"></div>
					<!--
							<div class="col-xs-2">
