			...
			<div class="box">
				<div class="box-header">
					<div class="box-body" style="background-color:lightblue">
						<form action="<?= base_url() ?>index.php/update_jurnal/filter_update_jurnal_buk" method="post">
							<table>
								<tr>
									...
									<td width="20%">
										<select name="filter_by" id="filter_by" class="form-control input-sm">
											<?php
											if ($filter_by_ == "no_reff") {
											?>
												<option value="no_reff" selected>No. Reff</option>
												<option value="keterangan">Keterangan</option>
												<option value="no_jurnal">No. Jurnal</option>
											<?php
											} elseif ($filter_by_ == "keterangan") {
											?>
								...
								<tr>
									...
									<td>
										...
										<a href="<?= base_url() ?>index.php/update_jurnal/update_buk" title='Refresh' class='btn btn-primary btn-sm'><i class='fa fa-refresh'></i> Refresh</a>
									</td>
								</tr>
							</table>
						</form>
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									?>
											<tr bgcolor='#DCDCDC'>
												<td align="center"><a href="<?= base_url() ?>index.php/update_jurnal/edit_jurnal_buk/<?= $row->nomor ?>" data-toggle="tooltip" title="Click for edit"><?= $row->nomor ?></a></td>
												...
												<td style="text-align:center"><a href="<?= base_url() ?>index.php/update_jurnal/edit_jurnal_buk/<?= $row->nomor ?>" title='Edit' class='btn btn-primary btn-sm'><i class='fa fa-pencil-square-o'></i> Edit</a></td>
											</tr>
									<?php
										}
									}
