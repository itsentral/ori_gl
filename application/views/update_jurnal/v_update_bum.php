...
if ($data_jarh) {
	foreach ($data_jarh as $row_jarh) {
		$nomor_bum				= $row_jarh->nomor;
		$tgl_bum				= $row_jarh->tgl;
		$terima_dari			= $row_jarh->terima_dari;
		$note					= $row_jarh->note;
		$jenis_transaksi		= $row_jarh->jenis_reff;
	}
}
$jml_total = 0;
if ($data_jurnal) {
...
<section class="content">
	<div class="row">
		<div class="col-lg-12 col-xs-12">
			<form method="post" action="<?= base_url() ?>index.php/update_jurnal/proses_update_bum" id="form-proses-bro">
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control input-sm" name="nomor_jurnal" id="nomor_jurnal" value="<?= $nomor_bum ?>" readonly>
							</div>
							<label class="control-label col-sm-2">Tgl Input</label>
							<div class="col-sm-4">
								<!-- TGL INPUT -->
								<input type="text" class="form-control" size='1' id="datepicker" name="tanggal" value="<?= date_format(new DateTime($tgl_bum), "d-m-Y") ?>" data-date-format="dd-mm-yyyy">
							</div>
						</div>
						<div class="form-group row">
							<label class="control-label col-sm-2">Terima dari</label>
							<div class="col-sm-4">
								<input type="text" class="form-control input-sm" name="terima_dari" id="terima_dari" autocomplete="off" value="<?= $terima_dari ?>">
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<div class="btn-group">
									...
									<?php
									// $chk1	= $chk2 = '';
									// if ($row_jarh->bon == "Ada Bon") {
									// 	$chk1	= 'checked';
									// } else if ($row_jarh->bon == "Tidak Ada Bon") {
									// 	$chk2	= 'checked';
									// }
									?>
					...
					<div class="box-footer">
						...
						?>
						<a href="<?= base_url() ?>index.php/update_jurnal/update_bum" class="btn btn-danger">KEMBALI</a>
					</div>
				</div>
