					...
					<tr>
					  ...
					  <td>
						<!--
							...
							-->
							<div class="btn-group">
								<a href="<?=base_url()?>index.php/setup/ke_EditUser/<?=$row->pn_id?>" class='btn btn-warning'>Edit</a>
								
							</div>
							<div class="btn-group">								
								<a href="<?=base_url()?>index.php/setup/ke_HapusUser/<?=$row->pn_id?>" class='btn btn-danger'>Hapus</a>
							</div>
