...
class Report_model extends CI_Model
{
	...
	{
		$kode_cabang	= $this->session->userdata('kode_cabang');
		$query 	= "SELECT * FROM COA WHERE (no_perkiraan like '53%') AND level='$level' AND bln='$var_bulan' AND thn='$var_tahun' and kdcab='$kode_cabang' ORDER BY no_perkiraan ASC";
		$query	= $this->db->query($query);
		if ($query->num_rows() > 0) {
			return $query->result();
		} else {
	...
	{
		$kode_cabang	= $this->session->userdata('kode_cabang');
		$query 	= "SELECT * FROM COA WHERE (no_perkiraan like '54%') AND level='$level' AND bln='$var_bulan' AND thn='$var_tahun' and kdcab='$kode_cabang' ORDER BY no_perkiraan ASC";
		$query	= $this->db->query($query);
		if ($query->num_rows() > 0) {
			return $query->result();
		} else {
	...
	{
		$kode_cabang	= $this->session->userdata('kode_cabang');
		$query 	= "SELECT * FROM COA WHERE (no_perkiraan like '55%') AND level='$level' AND bln='$var_bulan' AND thn='$var_tahun' and kdcab='$kode_cabang' ORDER BY no_perkiraan ASC";
		$query	= $this->db->query($query);
		if ($query->num_rows() > 0) {
			return $query->result();
		} else {
	...
	{
		$kode_cabang	= $this->session->userdata('kode_cabang');
		$query 	= "SELECT * FROM COA WHERE (no_perkiraan like '56%') AND level='$level' AND bln='$var_bulan' AND thn='$var_tahun' and kdcab='$kode_cabang' ORDER BY no_perkiraan ASC";
		$query	= $this->db->query($query);
		if ($query->num_rows() > 0) {
			return $query->result();
		} else {
	...
	{
		$kode_cabang	= $this->session->userdata('kode_cabang');
		$query 	= "SELECT * FROM COA WHERE (no_perkiraan like '57%') AND level='$level' AND bln='$var_bulan' AND thn='$var_tahun' and kdcab='$kode_cabang' ORDER BY no_perkiraan ASC";
		$query	= $this->db->query($query);
		if ($query->num_rows() > 0) {
			return $query->result();
		} else {
	...
	{
		$kode_cabang	= $this->session->userdata('kode_cabang');
		$query 	= "SELECT * FROM COA WHERE (no_perkiraan like '58%') AND level='$level' AND bln='$var_bulan' AND thn='$var_tahun' and kdcab='$kode_cabang' ORDER BY no_perkiraan ASC";
		$query	= $this->db->query($query);
		if ($query->num_rows() > 0) {
			return $query->result();
		} else {
